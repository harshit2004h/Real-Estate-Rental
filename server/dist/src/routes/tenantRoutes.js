...
router.post("/:cognitoId/favourites/:propertyId", tenantControllers_1.addFavouriteProperty);
router.delete("/:cognitoId/favourites/:propertyId", tenantControllers_1.removeFavouriteProperty);
